...
/**
 * Model-based command: mark the message at $index Failed (a no-op when fewer
 * than $index + 1 messages exist).
 */
final readonly class FailCommand implements Command
{
